export default function Home() {
  return (
    <div className="flex flex-col gap-2 mx-auto w-9/10 pt-15 md:pt-10">
      <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto possimus, laborum dignissimos voluptate esse quidem voluptatibus vel delectus aspernatur accusantium voluptas quisquam, laboriosam, culpa quod vero itaque. Assumenda, aperiam optio.</h1>
